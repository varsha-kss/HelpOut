...
import 'package:help_out/screens/others2.dart';
import 'package:help_out/screens/others3.dart';
import 'package:help_out/screens/others4.dart';

class Donationlinks extends StatefulWidget {
  @override
  _donationlinkstate createState() => _donationlinkstate();
}

class _donationlinkstate extends State<Donationlinks> {
  TextEditingController _searchController = TextEditingController();
  String _searchQuery = '';

  Map<String, Widget> _orphanagePages = {
    'PM REFLIEF FUNDS': donationlink1(),
    'UNICEF INDIA': donationlink2(),
    'UNHCR': donationlink3(),
    'BAL RAKSHA BHARAT':donationlink4(),
  };
